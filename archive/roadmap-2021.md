...
- Release **sigs.k8s.io/kustomize/api** **v1.0.0** ([PROJECT](https://github.com/nholuongut/kustomize/projects/5))
  - [Fewer public packages](https://github.com/nholuongut/kustomize/issues/3942):
  ...
  - [Vendor all transitive deps](https://github.com/nholuongut/kustomize/issues/3706).
    Since kustomize is in kubectl, we must do as kubectl does to manage deps, exposing new transitive deps in code review.
  - [Remove starlark dependencies](https://github.com/nholuongut/kustomize/issues/3943) (but make it possible to re-enable via injection)
- **Kustomization v1 (also end-user impact)** ([PROJECT](https://github.com/nholuongut/kustomize/projects/12))
  - [Deprecate `vars` field](https://github.com/nholuongut/kustomize/issues/2052). Allowed but no longer honored. This includes:
    - merging and documenting the [ReplacementTransformer](https://github.com/nholuongut/kustomize/issues/3492)
    - [supporting vars→replacements migration in `kustomize edit fix`](https://github.com/nholuongut/kustomize/issues/3849), with documentation
    - emitting warnings on stderr pointing users to the migration plan
  - [Deprecate `crds` field](https://github.com/nholuongut/kustomize/issues/3944) with migration instructions to “openapi"
  - [Add `reorder` field](https://github.com/nholuongut/kustomize/issues/3913). Default should be FIFO and legacy should also be supported (could add alphabetic and custom sort support eventually). Replaces -reorder flag.
  - [Consider deprecating `configurations` field](https://github.com/nholuongut/kustomize/issues/3945) (old, pre-plugin, pre-openapi global configuration)
- Improve contributor documentation
  ...
  - [Add a top-level ARCHITECTURE.md document](https://github.com/nholuongut/kustomize/pull/3924).
  - [Improve docs for kyaml libraries](https://github.com/nholuongut/kustomize/issues/3950), especially by adding examples.
  - [Instructions to upgrade kustomize-in-kubectl](https://github.com/nholuongut/kustomize/issues/3951) (how to make a PR like [this one](https://github.com/kubernetes/kubernetes/pull/101120)). The description of that PR contains the instructions that worked on that particular date. Let this happen frequently
- [Improve the release process](https://github.com/nholuongut/kustomize/issues/3952) to support regular biweekly releases [PROJECT](https://github.com/nholuongut/kustomize/projects/7)
  ...
  - Send kustomize CLI version number into kubectl ([kubectl issue](https://github.com/kubernetes/kubectl/issues/797) / [kustomize issue](https://github.com/nholuongut/kustomize/issues/1424))
- Project administration
  ...
  - [Rename master branch to main](https://github.com/nholuongut/kustomize/issues/3954)
...
- Improve end-user documentation [PROJECT](https://github.com/nholuongut/kustomize/projects/9)
  - Easily discovered [tutorials](https://github.com/nholuongut/kustomize/issues/3973) for folks who just want to get the job done.
    Implicit best practice recommendation.
  - Usage [tutorial](https://github.com/nholuongut/kustomize/issues/3973) videos
  - Clear explanation of differing capabilities of kustomize standalone vs. kustomize in kubectl. [Document kubectl kustomize integration #3951](https://github.com/nholuongut/kustomize/issues/3951)
  - [The kustomize doc site should pull examples from the kustomize repo](https://github.com/nholuongut/kustomize/issues/3974)
- [Telemetry to guide investment decisions](https://github.com/nholuongut/kustomize/issues/3941) ([PROJECT](https://github.com/nholuongut/kustomize/projects/13))
  ...
  -  A battery of [Go benchmark tests](https://github.com/nholuongut/kustomize/issues/3248) to monitor performance. We've had reports of performance regression, but no measures *in-repo*.
- **kustomize cli v5** ([PROJECT](https://github.com/nholuongut/kustomize/projects/14))
  - [Indentation changes from go-yaml](https://github.com/nholuongut/kustomize/issues/3946), if we cannot prevent them in kubectl kustomize. (also related to a [kyaml feature request](https://github.com/nholuongut/kustomize/issues/3559))
  - [Drop the `--reorder` flag](https://github.com/nholuongut/kustomize/issues/3947)
  - [Decide what to do with `kustomize cfg`](https://github.com/nholuongut/kustomize/issues/3953)
...
- Features
  - [Kustomize Components KEP](https://github.com/kubernetes/enhancements/tree/master/keps/sig-cli/1802-kustomize-components)
    - Needs end-user docs
  - [OpenAPI KEP](https://github.com/nholuongut/kustomize/issues/3723)
     -  Should deprecate[ the existing `crds` field](https://kubectl.docs.kubernetes.io/references/kustomize/kustomization/crds/)
  - [Binary releases for M1 (darwin_arm64)](https://github.com/nholuongut/kustomize/issues/3736)
  - [confusion around namespace replacement](https://github.com/nholuongut/kustomize/issues/880) - this is the most +1’d feature request and is two years old
  ...
  - git caching scheme (behind a flag) https://github.com/nholuongut/kustomize/pull/3655
  - hashicorp go-getter support via dependency injection or [external plugin](https://github.com/nholuongut/kustomize/issues/3585)
...
- Replace `Resource` fields with annotations so that the data is visible to and survives across KRM function boundaries:
  - [Replace Resource.options with annotations #3975](https://github.com/nholuongut/kustomize/issues/3975)
  - [Replace Resource.refBy with annotations #3976](https://github.com/nholuongut/kustomize/issues/3976)
- Create KEP for plugin [graduation](https://github.com/nholuongut/kustomize/issues/2721) out of alpha. [PROJECT](https://github.com/nholuongut/kustomize/projects/15)
