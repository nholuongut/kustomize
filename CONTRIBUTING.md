...
[Kustomize OWNERS_ALIASES]: https://github.com/nholuongut/kustomize/blob/8049f7b1af52e8a7ec26faf6cf714f560d0043c5/OWNERS_ALIASES
...
1. Visit https://github.com/nholuongut/kustomize
...
# Configure upstream
git remote add upstream https://github.com/nholuongut/kustomize
...
- Demonstrate deeper understanding of kustomize goals. This can take many forms and is a bit subjective, but here are a few examples:
  ...
  - filing an issue describing a long term problem and solution aligned with kustomize goals, for example: https://github.com/nholuongut/kustomize/issues/5140
  - writing up KEPs for features that will improve the kustomize workflow while being aligned with kustomize goals, for example: https://github.com/nholuongut/kustomize/pull/4558
...
- If the PR is introducing a bug fix:
  ...
  - The PR should have two distinct commits:
    ...
    - Some sample PRs:
      - https://github.com/nholuongut/kustomize/pull/5263/commits
      - https://github.com/nholuongut/kustomize/pull/3931/commits
...
## Triage guide
The possible triage labels are listed here: https://github.com/nholuongut/kustomize/labels?q=triage.
...
- Once you feel ready, you can label it with a triage label. Here's an [example](https://github.com/nholuongut/kustomize/issues/5049). You can also
...
full list [here](https://github.com/nholuongut/kustomize/labels?q=triage).
...
requests are issues labeled kind/feature, and you can find them [here](https://github.com/nholuongut/kustomize/issues?q=is%3Aissue+is%3Aopen+kind+feature+label%3Akind%2Ffeature).
