...
func TestIsRemoteFile(t *testing.T) {
	cases := map[string]struct {
		...
		"https dir": {
			"https://github.com/nholuongut/kustomize//examples/helloWorld/",
			true,
		},
		"no scheme": {
			"github.com/nholuongut/kustomize//examples/helloWorld/",
			false,
		},
		"ssh": {
			"ssh://git@github.com/nholuongut/kustomize.git",
			false,
		},
		"local": {
			"pod.yaml",
