...
func TestNewRepoSpecFromUrl_Smoke(t *testing.T) {
	...
	testcases := []struct {
		...
		},
		{
			...
			input:     "https://github.com/nholuongut/kustomize//examples/multibases/dev/?ref=v1.0.6",
			cloneSpec: "https://github.com/nholuongut/kustomize",
			absPath:   notCloned.Join("/examples/multibases/dev"),
			repoSpec: RepoSpec{
				Host:         "https://github.com/",
				RepoPath:     "nholuongut/kustomize",
		...
		},
		{
			...
			input:     "ssh://git@github.com/nholuongut/kustomize//examples/multibases/dev?ref=v1.0.6",
			cloneSpec: "git@github.com:nholuongut/kustomize",
			absPath:   notCloned.Join("examples/multibases/dev"),
			repoSpec: RepoSpec{
				Host:         "git@github.com:",
				RepoPath:     "nholuongut/kustomize",
		...
		},
		{
			...
			input:     "ssh://org-12345@github.com/nholuongut/kustomize",
			cloneSpec: "org-12345@github.com:nholuongut/kustomize",
			absPath:   notCloned.String(),
			repoSpec: RepoSpec{
		...
		},
		{
			...
			input:     "org-12345@github.com/nholuongut/kustomize",
			cloneSpec: "org-12345@github.com:nholuongut/kustomize",
			absPath:   notCloned.String(),
			repoSpec: RepoSpec{
				Host:     "org-12345@github.com:",
