...
// https://raw.githubusercontent.com/nholuongut/kustomize/master/api/krusty/testdata/localize/simple/service.yaml ->
// localized-files/raw.githubusercontent.com/nholuongut/kustomize/master/api/krusty/testdata/localize/simple/service.yaml.
//
...
func parseHost(repoSpec *git.RepoSpec) (string, error) {
	...
	case "gh:":
		...
		// https://github.com/nholuongut/kustomize/blob/kustomize/v4.5.7/api/internal/git/repospec.go#L203
