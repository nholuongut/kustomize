...
`
	...
	simpleURL = "https://github.com/nholuongut/kustomize//api/krusty/testdata/localize/simple"
...
func TestBadArgs(t *testing.T) {
	...
	for name, test := range map[string]struct {
		...
		"target_no_ref": {
			target: simpleURL,
			err:    `localize remote root "https://github.com/nholuongut/kustomize//api/krusty/testdata/localize/simple" missing ref query string parameter`,
		},
		"non-empty_scope": {
...
`
	fsExpected, fsActual, testDir := PrepareFs(t, nil, map[string]string{
		"kustomization.yaml": fmt.Sprintf(kustf, `https://raw.githubusercontent.com/nholuongut/kustomize/kustomize/v4.5.7/api/krusty/testdata/customschema.json`),
	})
...
- https://github.com/nholuongut/kustomize//api/krusty/testdata/localize/remote?submodules=0&ref=master&timeout=300
`,
	})
...
func TestResourcesRepoNotFile(t *testing.T) {
	const repo = "https://github.com/nholuongut/kustomize" + urlQuery
...
func TestExistingCacheDir(t *testing.T) {
	const remoteFile = `https://raw.githubusercontent.com/nholuongut/kustomize/master/api/krusty/testdata/localize/simple/deployment.yaml`
