...
func TestRemoteLoad_RemoteProtocols(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			kustomization: `
resources:
- https://github.com/nholuongut/kustomize//examples/multibases/dev/?submodules=0&ref=kustomize%2Fv4.5.7&timeout=300
`,
		},
		{
			...
			kustomization: `
resources:
- https://github.com/nholuongut/kustomize.git//examples/multibases/dev/?submodules=0&ref=kustomize%2Fv4.5.7&timeout=300
`,
		},
		{
			...
			kustomization: `
resources:
- git::https://github.com/nholuongut/kustomize//examples/multibases/dev/?submodules=0&ref=kustomize%2Fv4.5.7&timeout=300
`,
		},
		{
			...
			kustomization: `
resources:
- https://raw.githubusercontent.com/nholuongut/kustomize/v3.1.0/examples/multibases/base/pod.yaml?timeout=300
namePrefix: dev-
`,
		},
		{
			...
			kustomization: `
resources:
- github.com/nholuongut/kustomize/examples/multibases/dev?submodules=0&ref=kustomize%2Fv4.5.7&timeout=300
`,
		},
		{
			name:       "ssh",
			...
			kustomization: `
resources:
- git@github.com/nholuongut/kustomize/examples/multibases/dev?submodules=0&ref=kustomize%2Fv4.5.7&timeout=300
`,
		},
		{
			name:       "ssh with colon",
...
`,
		},
		{
			...
			kustomization: `
resources:
- ssh://git@github.com/nholuongut/kustomize/examples/multibases/dev?submodules=0&ref=kustomize%2Fv4.5.7&timeout=300
`,
		},
		{
			name: "http error",
