...
[kustomize repo release page]: https://github.com/nholuongut/kustomize/releases
...
### ⚠️ IMPORTANT: Check for [release-blocking issues](https://github.com/nholuongut/kustomize/issues?q=label%3Arelease-blocker+is%3Aopen)
...
It is also a good idea to scan any [untriaged issues](https://github.com/nholuongut/kustomize/issues?q=is%3Aissue+is%3Aopen+label%3Aneeds-triage) for potential blockers we haven't labelled yet before proceeding.

### Consider fetching new OpenAPI data

Ideally, Kustomize's embedded openapi data would cover a wide range of Kubernetes releases. But today, we only embed a specific version. This means updating that version can be disruptive to people who still use older Kubernetes versions and depend on API versions that were removed in later releases. However, by remaining out of date, we will not support GVKs introduced in more recent releases. So far, we have leaned in favour of the older versions, because some removed GVs are for very popular APIs. This should be constantly reevaluated until a better solution is in place. See issue https://github.com/nholuongut/kustomize/issues/5016.
...
Example: https://github.com/nholuongut/kustomize/pull/5021
...
[Makefile]: https://github.com/nholuongut/kustomize/blob/master/Makefile
...
[kustomize release]: https://github.com/nholuongut/kustomize/releases
